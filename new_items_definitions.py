...
RAW_ITEMS: list[dict[str, Any]] = [
    ...
    # Q_len: 1, P_len: 3, Pos: 2
    {
        ...
        "critical_word_positive": "ikişer",
        "feature_delta": "her birine ayrı ayrı ↔ toplam",
        "edit_script": {
            "applies": False, "positive_form": "", "minimal_negative_form": "",
            "operation": "", "changed_feature": "", "invariants": [],
        },
        "query": "Afetzedelere ikişer çadır teslim edildi.",
        "context_sentences": [
        ...
        "candidates": [
            {
                "candidate_slot": "positive_01",
                "critical_sentence": "Resmi yardım kuruluşu afetzedelere çadırları ikişer ikişer verdi.",
    ...
    # Q_len: 1, P_len: 1, Pos: 1
    {
        ...
        "critical_word_query": "onaylatılmayan",
        "critical_word_positive": "onaylatılmadığı",
        "feature_delta": "başkasına yaptırılmama ↔ doğrudan yapılma / yaptırılma",
        "edit_script": {
            "applies": True,
            "positive_form": "onaylatılmadığı",
            "minimal_negative_form": "onaylatıldığı",
            "operation": "yalnız CAUS.PASS.NEG biçimini değiştir",
            "changed_feature": "CAUS.PASS.NEG",
            "invariants": ["lemma", "token_order", "event"],
        },
        "query": "Banka, resmi açıklamasında kurula onaylatılmayan borç yapılandırma evraklarını duyurdu.",
        "context_sentences": [],
        "candidates": [
            {
                "candidate_slot": "positive_01",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurula onaylatılmadığı bilgisini resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatılmadığı",
                "reason": "equivalence_positive",
            },
            {
                "candidate_slot": "hard_01",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurula onaylatıldığı bilgisini resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatıldığı",
                "reason": "minimal_morph_negative",
            },
            {
                "candidate_slot": "hard_02",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurula onaylatılmayacağını resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatılmayacağını",
                "reason": "same_lemma_wrong_inflection",
            },
            {
                "candidate_slot": "hard_03",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurula onaylatılmamış olduğunu resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatılmamış",
                "reason": "related_feature_negative",
            },
            {
                "candidate_slot": "hard_04",
                "critical_sentence": "Banka, borç yapılandırma evraklarının denetçiye onaylatılmadığı bilgisini resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatılmadığı",
                "reason": "same_morph_wrong_content",
            },
            {
                "candidate_slot": "hard_05",
                "critical_sentence": "Müdür, borç yapılandırma evraklarının kurula onaylatılmadığı bilgisini resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylatılmadığı",
                "reason": "state_participant_time_trap",
            },
            {
                "candidate_slot": "hard_06",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurula onaylatılmadığı bilgisini resmi yazıyla yalanladı.",
                "critical_word": "onaylatılmadığı",
                "reason": "close_paraphrase_wrong_meaning",
            },
            {
                "candidate_slot": "hard_07",
                "critical_sentence": "Banka, borç yapılandırma evraklarının kurulca onaylanmadığı bilgisini resmi yazıyla kayda geçirdi.",
                "critical_word": "onaylanmadığı",
                "reason": "partial_chain_negative",
            },
            {
                "candidate_slot": "hard_08",
                "critical_sentence": "Banka, kurula sunulan borç yapılandırma evraklarını resmi yazıyla kayda geçirdi.",
                "critical_word": "sunulan",
                "reason": "scope_attachment_trap",
            },
            {
                "candidate_slot": "easy_01",
    ...
    # Q_len: 2, P_len: 1, Pos: 1
    {
        ...
        "candidates": [
            {
                "candidate_slot": "positive_01",
                "critical_sentence": "Hukukçular, “Protokol taslağını masada birlikte inceleyelim,” dediler.",
            ...
            {
                "candidate_slot": "hard_04",
                "critical_sentence": "Hukukçular, “Kira sözleşmesini masada birlikte inceleyelim,” dediler.",
                "critical_word": "inceleyelim",
                "reason": "same_morph_wrong_content",
            },
            {
                "candidate_slot": "hard_05",
                "critical_sentence": "Stajyerler, “Protokol taslağını masada birlikte inceleyelim,” dediler.",
                "critical_word": "inceleyelim",
                "reason": "state_participant_time_trap",
            },
            {
                "candidate_slot": "hard_06",
                "critical_sentence": "Hukukçular, “Protokol taslağını masada birlikte reddedelim,” dediler.",
                "critical_word": "reddedelim",
                "reason": "close_paraphrase_wrong_meaning",
            },
            {
                "candidate_slot": "hard_07",
                "critical_sentence": "Hukukçular, “Masadaki başka bir taslağı birlikte inceleyelim,” dediler.",
                "critical_word": "inceleyelim",
                "reason": "argument_role_reversal",
            },
            {
