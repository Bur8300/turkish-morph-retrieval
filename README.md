...
| [`test/data/paid_pilot_verisi_15.json`](test/data/paid_pilot_verisi_15.json) | Sol + DeepSeek + GLM hattından kabul edilen 15-family ücretli smoke pilotu; insan-reviewed final veri değildir. |
