...
**90 queries, 990 pooled candidates.**
...
2. **Pooled BEIR (the standard task this export also supports)**: rank the FULL `corpus.jsonl`
   (990 docs) against every query. Harder and not equivalent: pooling candidates
   ...
   **12/90 queries** have at least one foreign candidate that
