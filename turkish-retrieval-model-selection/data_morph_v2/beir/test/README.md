...
**50 queries, 550 pooled candidates.**
...
2. **Pooled BEIR (the standard task this export also supports)**: rank the FULL `corpus.jsonl`
   (550 docs) against every query. Harder and not equivalent: pooling candidates
   ...
   **22/50 queries** have at least one foreign candidate that
